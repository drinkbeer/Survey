	...
	<table>
		...
		<tr>
			...
			<td class="tdSHeaderR">
				...
				<s:a action="PageAction_toAddPage" namespace="/">增加页</s:a>&nbsp;
			</td>
		</tr>
		<tr>
										...
										<td>
											<table>
												<tr>
													...
													<td class="tdPHeaderR">编辑页标题&nbsp; 移动/复制页&nbsp;
														增加问题&nbsp; 删除页&nbsp;</td>
												</tr>
											</table>
										</td>
																...
																<td>
																	<table>
																		...
																		<s:iterator var="q" value="#p.questions">
																			...
																			<tr>
																				<!-- 问题题干 -->
																				<td class="tdQHeaderL"><s:property
																						value="#q.title" /></td>
																				<td class="tdQHeaderR">编辑问题&nbsp; 删除问题&nbsp;</td>
																			</tr>
																			<tr>
																				<td colspan="2"
																					style="text-align: left; color: black; background-color: white">
																					<!-- 定义变量,设置第一大类的题型 --> <s:set var="qt"
																						value="#q.questionType" /> <!-- 判断当前题型是否属于第一大类(0,1,2,3) -->
																					<s:if test='#qt lt 4'>
																						...
																						<s:if test="#q.other">
																							<input
																								type='<s:property value="#qt < 2?'radio':'checkbox'" />'>其他
																							<!-- 文本框 -->
																					...
																					</s:if> <!-- text --> <s:if test="#qt == 5">
																						<input type="text">
																					</s:if> <!-- 矩阵问题(6,7,8) --> <s:if test="#qt > 5">
																						<table>
																							<!-- 列头 -->
																							<tr>
																								<td></td>
