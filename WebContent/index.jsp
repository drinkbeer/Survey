	...
	<s:form action="LoginAction_doLogin" namespace="/" method="post">
		<table>
			...
			<tr>
				...
				<td class="tdFormControl"><input type="text" name="email"
					class="text" value="chen.jb@tonkpay.com"> <font
					class="fonterror"><br>
					<s:actionerror></s:actionerror></font></td>
			</tr>
			<tr>
				<td class="tdFormLabel">密码:</td>
				<td class="tdFormControl"><input type="password"
					name="password" class="text" value="chen.jb@tonkpay.com"> <font
					class="fonterror"></font></td>
			</tr>
			<tr>
				<td class="tdFormLabel"></td>
				<td class="tdFormControl"><s:submit type="submit"
						cssClass="btn" value="登录" /></td>
			</tr>
		</table>
	</s:form>
</body>
