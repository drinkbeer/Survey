		...
		<table>
			...
			<s:iterator value="mySurveys">
				...
				<tr>
					...
					<td><s:a action="" cssClass="aList">收集信息</s:a></td>
					<td><s:a action="" cssClass="aList">分析</s:a></td>
					<td><s:a action="" cssClass="aList">打开/关闭</s:a></td>
					<td><s:a action="" cssClass="aList">清除调查</s:a></td>
					<td><s:a action="" cssClass="aList">删除</s:a></td>
				</tr>
			</s:iterator>
		</table>
	</s:else>
